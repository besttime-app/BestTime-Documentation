...
- **live** `bool` <span style="color:blue">OPTIONAL</span>
 Will display the live foot traffic data. Venues without live data will be filtered out. Note: The Venue Filter does NOT refresh the live data automatically. Use the Live API endpoint to refresh the data for example every hour. The local time of the first venue is taken that matches the filter criteria. Cannot be used in combination with the `now`, `day_int`, `hour_min`, and `hour_max` parameters. Note: Enabling live data increases API credit usage significantly and results in a slower response time.
 &nbsp;  
<!--
 - **live_limit** `int` <span style="color:blue">OPTIONAL</span>
Limits the maximum number of venues refreshed when `live` is set to `true`. Default `500`, min `0`, max `5000`.
 &nbsp;  
-->
- **types** `list` <span style="color:blue">OPTIONAL</span>
 Filters on one or more venue types. All types are selected if the `types` parameter is omitted. Possible types are (most common shown first) `ADULT, AGRICULTURE, AIRPORT, AMERICAN_RESTAURANT, AMUSEMENT_PARK, ANTIQUES, APPAREL, AQUARIUM, ARTS, ASIAN_RESTAURANT, AUDITORIUM, BAKERY, BANKING, BAR, BASEBALL, BBQ_RESTAURANT, BEER, BOATING, BOTANICAL_GARDEN, BREAKFAST_RESTAURANT, BREWERY, BRIDGE, BUDDHIST_TEMPLE, BURGER_RESTAURANT, BUS_STATION, CABLE_CAR_STATION, CAFE, CAR_RENTAL, CASH_MACHINE, CASINO, CEMETERY, CHICKEN_RESTAURANT, CHINESE_RESTAURANT, CHURCH, CITY_HALL, CLUBS, COFFEE, CONCERT_HALL, CONVENIENCE_STORE, CRICKET, DAYCARE, DENTIST, DESSERT, DOCTOR, DOG_PARK, ELECTRIC_VEHICLE_CHARGING_STATION, EMBASSY, EVENT_VENUE, FAIRGROUNDS, FAST_FOOD, FERRY_TERMINAL, FISHING, FITNESS, FOOD_AND_DRINK, FOOD_DELIVERY, FOOTBALL, FRENCH_RESTAURANT, FUNICULAR_STATION, GARDEN, GAS_STATION, GIFTS, GOLF, GOLF_COURSE, GONDOLA_LIFT_STATION, GOVERNMENT, GROCERY, GURUDWARA, HIKING, HINDU_TEMPLE, HISTORICAL, HOSPITAL, INDIAN_RESTAURANT, INDUSTRIAL, ITALIAN_RESTAURANT, JAIN_TEMPLE, JAPANESE_RESTAURANT, LIBRARY, LODGING, MARKET, MEDITERANEAN_RESTAURANT, MEXICAN_RESTAURANT, MILITARY, MONORAIL_STATION, MONUMENT, MORMON_TEMPLE, MOSQUE, MOVIES, MOVIE_THEATER, MUSEUM, NATIONAL_PARK, NATURE_RESERVE, OTHER, Other, PARK, PARKING, PERFORMING_ARTS, PERSONAL_CARE, PHARMACY, PIZZA_RESTAURANT, POLICE, POST_OFFICE, RAMEN_RESTAURANT, RESTAURANT, REST_AREA, REST_ROOM, RUGBY, SANDWICH_RESTAURANT, SCENIC_POINT, SCHOOL, SEAFOOD_RESTAURANT, SEAPORT, SHINTO_TEMPLE, SHOPPING, SHOPPING_CENTER, SKILL_INSTRUCTION, SOCCER, SOUVENIR_SHOP, SPA, SPORTING_GOODS, SPORTS_COMPLEX, STADIUM, STEAK_RESTAURANT, SUBWAY_STATION, SUPERMARKET, SUSHI_RESTAURANT, SWIMMING, SYNAGOGUE, TEA, TEMPLE, TENNIS, THAI_RESTAURANT, TOURIST_DESTINATION, TRAIN_STATION, TRAMWAY_STATION, TRANSIT_STATION, UNIVERSITY, VEGETERIAN_RESTAURANT, VEHICLE, VISITOR_CENTER, WINERY, WINTER_SPORTS, ZOO`
 &nbsp;
